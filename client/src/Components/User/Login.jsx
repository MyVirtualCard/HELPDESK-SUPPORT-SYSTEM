...
const handleSubmit = async (e) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950 overflow-hidden relative flex items-center justify-center px-4 py-10">
      ...
      {/* Main Card */}
      <div className="w-full max-w-6xl grid lg:grid-cols-2 bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[40px] overflow-hidden shadow-2xl relative z-10 animate-[fadeIn_0.8s_ease]">
